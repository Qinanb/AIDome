...
valid_dataloader=DataLoader(dataset=valid_dataset,batch_size=16,shuffle=True)
#从训练集中抽几张图片进行显示(可选)
...
static_dict = torch.load(r'D:\pydome\AI25-12\03_Deep_Learning\01_CNN_Progect\02_基于ResNet的蜜蜂蚂蚁分类\model\resnet18-5c106cde.pth', weights_only=True)
#使用模型加载状态字典
